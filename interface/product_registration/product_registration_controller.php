...
if ($method === 'POST') {
    ...
    if ($allowTelemetry) {
        ...
        if ($id > 0) {
            ...
            $sql = "INSERT INTO `product_registration` (`auth_by_id`, `telemetry_disabled`, `last_ask_date`, `last_ask_version`, `options`) VALUES (?, ?, ?, ?, ?)";
            $params = [$auth_by_id, $telemetry_disabled, $last_ask_date, $last_ask_version, $options];
        }
